...
# neutral_position_pwm = 1500, when it is set, what degree the leg will show.
...
def main():
    ...
    set_points = np.array([[0, 0, 0, 0], [45, 45, 45, 45], [-45, -45, -45, -45]])
    hardware_interface.set_actuator_postions(
        degrees_to_radians(set_points)
        )
